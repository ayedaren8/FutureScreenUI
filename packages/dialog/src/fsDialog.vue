	...
	<div class="dialog-mask" v-show="show">
		<div class="dialog-innerbox">
			...
			<div class="dialog-content">
				<slot name="default"
					><span class="dialog-content-palceholder">{{ text || '这是一个提示框!' }}</span></slot
				>
			</div>
			<div class="dialog-footer">
				<fs-button type="lightdark" @click="_cancel">取消</fs-button>
				<fs-button type="dark" @click="_confirm">确认</fs-button>
			</div>
		</div>
	</div>
</template>
